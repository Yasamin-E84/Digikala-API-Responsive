...
${l.text}                </p>
    ...
    `;document.querySelector(".mobile-amazing-items").innerHTML+=s.join("")+t}catch(e){console.log(e.message)}}const Z="/Digikala-API-Responsive/";async function Hs(){function e(t){const i=["۰","۱","۲","۳","۴","۵","۶","۷","۸","۹"];return String(t).replace(/\d/g,n=>i[Number(n)])}function s(){const t=document.querySelectorAll(".second"),i=document.querySelectorAll(".minute"),n=document.querySelectorAll(".hour");if(!t.length&&!i.length&&!n.length)return;const r=new Date,l=new Date;l.setHours(24,0,0,0);let o=Math.floor((l-r)/1e3);o<=0&&(l.setDate(l.getDate()+1),o=Math.floor((l-r)/1e3));const a=e(String(Math.floor(o/3600)).padStart(2,"0")),c=e(String(Math.floor(o%3600/60)).padStart(2,"0")),m=e(String(o%60).padStart(2,"0"));n.forEach(u=>{u.textContent=a,u.classList.add("font-number")}),i.forEach(u=>{u.textContent=c,u.classList.add("font-number")}),t.forEach(u=>{u.textContent=m,u.classList.add("font-number")})}setInterval(s,1e3),s();try{const i=(await A()).ads.map(n=>`
    ...
    `,o=document.querySelector(".mobile-incredible-items");o&&(o.innerHTML=r.join("")+l)}catch(t){console.log(t.message)}new B(".inc-swiper",{modules:[W],slidesPerView:"auto",spaceBetween:2,navigation:{nextEl:".inc-next",prevEl:".inc-prev"}})}async function qs(){try{const s=(await A()).amazing.map(t=>`
    ...
    `}document.querySelector(".grouping-mobile").innerHTML=t}catch(e){console.log(e.message)}new B(".grouping-swiper",{modules:[W],slidesPerView:7.5,spaceBetween:60,navigation:{nextEl:".grouping-next",prevEl:".grouping-prev"}})}async function Ds(){try{const s=(await A()).partner.map(t=>`
...
<img src="${Ws}img/inc/toman.svg" alt="" class="w-5">             
  ...
  `}function ti(){const e=document.querySelector("[data-fixed-super]"),s=document.querySelector("[data-fixed-help]");if(!e&&!s)return;const t=e?.querySelector("[data-fixed-super-open]"),i=e?.querySelector("[data-fixed-super-backdrop]"),n=e?.querySelector("[data-fixed-super-panel]"),r=e?.querySelectorAll("[data-fixed-super-close]")||[],l=e?.querySelector("[data-super-label-collapsed]"),o=e?.querySelector("[data-super-label-expanded]"),a=s?.querySelector("[data-help-open]"),c=s?.querySelectorAll("[data-help-close]")||[],m=s?.querySelector("[data-help-panel]"),u=s?.querySelector("[data-help-close]:not([data-help-panel] [data-help-close])"),b=s?.querySelector("[data-help-mobile-bubble]"),f=s?.querySelector("[data-help-mobile-float]"),h="w-[140px]",v="w-[300px]";let x=!1;function d(M){!t||!i||!n||(i.classList.toggle("hidden",!M),n.classList.toggle("hidden",!M),t.setAttribute("aria-expanded",M?"true":"false"))}function p(M){!t||!l||!o||(t.classList.toggle(h,!M),t.classList.toggle(v,M),l.classList.toggle("hidden",M),o.classList.toggle("hidden",!M),o.classList.toggle("flex",M))}function g(){!a||!m||(a.classList.add("hidden"),u&&(u.classList.remove("hidden"),u.classList.add("flex")),m.classList.remove("hidden"),m.classList.add("flex"),d(!1))}function w(){!a||!m||(a.classList.remove("hidden"),u&&(u.classList.add("hidden"),u.classList.remove("flex")),m.classList.add("hidden"),m.classList.remove("flex"))}function S(){const C=document.documentElement.scrollHeight-window.innerHeight;if(C<=0)return;const y=window.scrollY/C;p(y>=.1),y>=.1&&window.innerWidth<1024&&!x&&(x=!0,b?.classList.add("hidden"),setTimeout(()=>{f?.classList.remove("hidden"),f?.classList.add("animate-bounce")},2e3))}t?.addEventListener("click",()=>d(!0)),i?.addEventListener("click",()=>d(!1)),r.forEach(M=>M.addEventListener("click",()=>d(!1))),a?.addEventListener("click",g),c.forEach(M=>M.addEventListener("click",w)),document.addEventListener("keydown",M=>{M.key==="Escape"&&(w(),d(!1))}),window.addEventListener("scroll",S,{passive:!0}),p(!1),d(!1),w(),S()}function si(){const e=document.querySelector("[data-fixed-super]"),s=document.querySelector("[data-fixed-help]");!e||!s||A().then(t=>{const i=t.fixedSupermarket;if(i){const r=e.querySelector("[data-super-label-collapsed]"),l=e.querySelector("[data-super-title-short]"),o=e.querySelector("[data-super-tagline]"),a=e.querySelector("[data-fixed-super-basket-img]"),c=e.querySelector("[data-fixed-super-modal-title]"),m=e.querySelector("[data-fixed-super-modal-sub]"),u=e.querySelector("[data-fixed-super-cards]");r&&(r.textContent=i.buttonTitle||"سوپرمارکت"),l&&(l.textContent=i.buttonTitle||"سوپرمارکت"),o&&(o.textContent=i.buttonTagline||"تنوع بالا و پرتخفیف"),a&&(a.src=i.basketIcon||""),c&&(c.textContent=i.modalTitle||""),m&&(m.textContent=i.modalSubtitle||""),u&&Array.isArray(i.cards)&&(u.innerHTML=i.cards.map(Js).join(""))}const n=t.fixedHelp;if(n){const r=s.querySelector("[data-help-icon]"),l=s.querySelector("[data-help-icon-mobile]"),o=s.querySelector("[data-help-mobile-bubble-text]"),a=s.querySelector("[data-help-mobile-float-text]"),c=s.querySelector("[data-help-h-title]"),m=s.querySelector("[data-help-greeting]"),u=s.querySelector("[data-help-intro]"),b=s.querySelector("[data-help-faq]"),f=s.querySelector("[data-help-call]"),h=s.querySelector("[data-help-mobile-link]");r&&(r.src=n.icon||""),l&&(l.src=n.icon||""),o&&(o.textContent=n.mobileFloatingText||"پشتیبانی آنلاین"),a&&(a.textContent=n.mobileFloatingText||"پشتیبانی آنلاین"),c&&(c.textContent=n.headerTitle||"پشتیبانی آنلاین"),m&&(m.textContent=n.greeting||"سلام 👋👋"),u&&(u.textContent=n.intro||""),b&&Array.isArray(n.faq)&&(b.innerHTML=n.faq.map(v=>ei(v.question,v.answer)).join("")),n.callUs?.href&&(f&&(f.href=n.callUs.href),h&&(h.href=n.callUs.href))}}).catch(t=>console.log(t.message)).finally(ti)}si();const ii=await A();async function ni(){try{const e=ii.menu.map(s=>{const t=s.text.includes("دسته")||s.type==="category";return`
      ...
      `},s=function(x){return x.map(d=>`
          ...
          `).join("")},t=function(x){return x.map(d=>`
            <div class="mb-4">
        ...
        <div>
          ...
          ${x.columns.map(d=>i(d)).join("")}
        </div>
      `},r=function(x){const d=m.querySelectorAll("[data-tabs-item]");d.forEach(g=>{g.classList.remove("bg-white","text-[#ef4056]","border-r-2","border-r-[#ef4056]"),g.classList.add("bg-[#f0f0f1]","text-[#424750]","border-r-transparent")});const p=d[x];p&&(p.classList.remove("bg-[#f0f0f1]","text-[#424750]","border-r-transparent"),p.classList.add("bg-white","text-[#ef4056]","border-r-2","border-r-[#ef4056]"),u.innerHTML=n(a.megaMenu[x]),u.scrollTop=0)},l=function(x){x.preventDefault(),v()&&(c.classList.remove("hidden"),c.classList.add("block"),requestAnimationFrame(()=>{f?.classList.remove("opacity-0"),h?.classList.remove("translate-y-full")}),document.body.classList.add("overflow-hidden"),r(0))},o=function(){f?.classList.add("opacity-0"),h?.classList.add("translate-y-full"),window.setTimeout(()=>{c.classList.add("hidden"),c.classList.remove("block")},280),document.body.classList.remove("overflow-hidden")};const a=await A(),c=document.querySelector("[data-tabs]"),m=document.querySelector("[data-tabs-list]"),u=document.querySelector("[data-tabs-content]"),b=document.querySelector("[data-tabs-close]"),f=document.querySelector("[data-tabs-backdrop]"),h=document.querySelector("[data-tabs-sheet]");if(!c||!m||!u)return;const v=()=>window.matchMedia("(max-width: 1023px)").matches;m.innerHTML=a.megaMenu.map((x,d)=>`
          <button
            type="button"
        ...
        `).join(""),m.querySelectorAll("[data-tabs-item]").forEach(x=>{x.addEventListener("click",()=>{r(Number(x.dataset.tabsIndex))})}),document.addEventListener("click",x=>{x.target.closest("[data-tabs-open]")&&l(x)}),b?.addEventListener("click",o),f?.addEventListener("click",o),document.addEventListener("keydown",x=>{x.key==="Escape"&&!c.classList.contains("hidden")&&o()})}catch(e){console.log(e.message)}}Ts();Is();Ls();Re();De();Xe();Ye();zs();ws();We();Os();Bs();Hs();qs();Vs();Ds();Gs();Fs();Ns();Rs();Ys();Xs();Ks();Qs();ni();ri();
